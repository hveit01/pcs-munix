...
#ifdef HV
static floatx80 floatx80_one = packFloatx80(0, 0x3fff, 0x8000000000000000U);
static floatx80 floatx80_default_nan = packFloatx80(0, 0xffff, 0xffffffffffffffffU);
#else
static floatx80 floatx80_one = { 0x3fff, 0x8000000000000000U };
static floatx80 floatx80_default_nan = { 0xffff, 0xffffffffffffffffU };
#endif
