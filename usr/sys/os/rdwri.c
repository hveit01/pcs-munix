/* @(#)rdwri.c  6.4 */
static char* _Version = "@(#) RELEASE:  1.0  Jul 09 1986 /usr/sys/os/rdwri.c ";
...
register struct inode *ip;
{
    ...
    register dev_t dev;  /*d7*/
    register daddr_t bn; /*d6*/
    register unsigned on, n; /*d5, var20*/
    int type; /*var24*/
    ...
    case IFLNK: /*pcs*/
        do {
            ...
            if (type == IFREG && (u.u_callno==59 || u.u_callno== -4))   /*pcs*/
                bp->b_flags |= B_AGE;                                   /*pcs*/
            brelse(bp);
            ip->i_flag |= IACC;
