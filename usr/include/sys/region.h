...
#ifdef MUNET
	dev_t   r_rmt_dev;      /* device of remote file (MUNET)       */
	ino_t   r_rmt_ino;      /* inode number of remote file (MUNET) */
	dev_t   r_rmt_id;       /* id of remote node (major/minor dev)  */
#endif
...
typedef struct dbd {
	ulong   dbd_type  :  4; /* The values for this field are given  */
				/* below.				*/
	ulong   dbd_swpi  :  4; /* The index into swaptab for the       */
...
#	define	dbd_adjunct	dbd_swpi
	...
	ulong   dbd_blkno : 24; /* The block number or i_map index.     */
} dbd_t;
...
#define DBD_FILE	5	/* This page matches a block on the	*/
				/* file system				*/
#define DBD_PHYS        6       /* This page matches a page of physical */
				/* memory, e.g. a bitmap display        */
