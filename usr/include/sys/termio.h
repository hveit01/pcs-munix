...
#define	CESC	'\\'
#define CINTR   0x03    /* cntl c */
#define CQUIT   0x19    /* cntl y */
#define CERASE  0x7f    /* DEL */
#define CKILL   0x18    /* CAN, ctl-x */
#define CEOF    032     /* cntl z */
#define	CSTART	021	/* cntl q */
#define	CSTOP	023	/* cntl s */
#define CSWTCH  0x02    /* ctl-b */
#define	CNSWTCH	0
/* csh support */
#define CSUSP	0x02	/* ctl-b */
#define CDSUSP	0x17	/* ctl-w */
...
#define TCCLR   (TIOC|30)       /* UH : reset Terminal driver */
#define TCBIPADR (TIOC|31)      /* UH: get Bitmap base address */
