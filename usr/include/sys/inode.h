...
/* Cadmus */
#define ILAND   0x4000          /* inode is a special network directory */
#ifdef SELECT
#define ISEL    0x8000          /* inode is polled by select */
#endif
...
#define         IFLAN   0xe000 /* lan block special */
#define         IFLNK   0xa000 /* symbolic link */
#define		IFIFO	0x1000	/* fifo special */
#define         IFSOCK  0xc000  /* socket special */
